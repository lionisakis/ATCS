...
preproceses_data_enlSEAR={"D":"days_ago","W":"weeks_ago","M":"months_ago","Y":"years_ago","N":"not_very",
 "Mi":"moderately_intense","I":"intense","Vi":"very_intense","Fm":"a_few_minutes",
 "H":"an_hour","Sh":"several_hours","Dom":"a_day_or_more","Ml":"male", "Fl":"female", "O":"other", "GBR":"United Kingdom", "IRL":"Ireland"}

class CustomDataset(Dataset):
    def __init__(self, tsv_file,target_group,Possible_Emotions=["Anger", "Disgust", "Fear", "Guilt", "Joy", "Sadness", "Shame"]):
    ...
    def __getitem__(self, idx):
        return self.target_group[idx], self.Sentence[idx], self.Prior_Emotion[idx], self.Annotation[idx], self.Possible_Emotions